    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-white to-lavender-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">We're glad you're here</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg border border-lavender-100">
          ...
          <button
            onClick={() => {
              setFormData({ email: 'demo@mamakokoro.jp', password: 'demo123' });
              toast.info('Demo credentials filled in');
            }}
            className="w-full bg-lavender-50 text-lavender-600 py-3 rounded-2xl font-semibold border border-lavender-200 hover:bg-lavender-100 transition-all text-sm"
          >
            Try Demo Account
          </button>
          ...
          <div className="text-center mt-5">
            <p className="text-gray-500 text-sm">
              New here?{' '}
              <Link to="/register" className="text-lavender-500 hover:text-lavender-600 font-semibold">
                Create an account
              </Link>
            </p>
          </div>
